...
public class SolutionDao {
    ...
    private static final String FIND_ALL_WITH_LIMIT = "SELECT * FROM solutions ORDER BY created LIMIT ?"; // zapytanie pobierające rozwiązania posortowane po dacie utworzenia i z limitem rekordów
